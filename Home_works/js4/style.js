...
//
// }
// const avarage1=avarage([1,2,3,4,5])
...
// const arr = [{age:25},{name:'ssfsf'},{index:12,car:'Porsche',size:22}];
// let x=0;
// function aoe(array){
//     for (const item of array) {
//         if(typeof item==='object'){
...
function xxx(arrayUsers,idTag){
const block=document.getElementById('box');
const ul=document.createElement('ul');
    for (let i = 0; i < arrayUsers; i++) {
